...
* 
* * Requires the minimum version of PHP 8.2
...
* * * **```sudo apt update```**
* * * **```sudo apt install -y software-properties-common git unzip apache2 mysql-server php8.2-{cli,curl,bcmath,memcached,dev,bz2,intl,pgsql,sqlite3,xmlrpc,xml,gd,json,mbstring,mysql,zip,soap,intl,readline} libapache2-mod-php8.2 phpmyadmin composer```**
...
* * * <a href="https://sourceforge.net/projects/xampp/files/XAMPP%20Windows/8.2.12/xampp-windows-x64-8.2.12-0-VS16-installer.exe/download">Download: xampp-windows-x64-8.2.12-0-VS16-installer.exe</a>
...
* 
* * Requer a versão mínima do PHP 8.2
...
* * * <a href="https://sourceforge.net/projects/xampp/files/XAMPP%20Windows/8.2.12/xampp-windows-x64-8.2.12-0-VS16-installer.exe/download">Baixar: xampp-windows-x64-8.2.12-0-VS16-installer.exe</a>
